...
class Symbiflow(Edatool):
    ...
    def configure_vpr(self):
        ...
        self.render_template("symbiflow-vpr-cmakelists.j2", "CMakeLists.txt", cmake_params)
...
class SymbiflowMake(Edatool):
    ...
    def configure_vpr(self):
        ...
        template = self.jinja_env.get_template('/'.join([template_dir, "symbiflow-vpr-makefile.j2"]))
