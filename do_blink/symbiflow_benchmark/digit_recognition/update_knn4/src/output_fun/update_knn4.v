...
(* CORE_GENERATION_INFO="update_knn4_update_knn4,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu9eg-ffvb1156-2-e,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=2.920000,HLS_SYN_LAT=31108,HLS_SYN_TPT=20298,HLS_SYN_MEM=34,HLS_SYN_DSP=0,HLS_SYN_FF=4051,HLS_SYN_LUT=10319,HLS_VERSION=2020_2}" *)
...
update_knn4_fifo_w32_d1024_A knn_out7_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
