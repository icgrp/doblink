...
generate
	for(i=0; i < 49; i=i+1) begin
		SYN_IBUF out_ibuf_dout_leaf_2(.I(dout_leaf_2[i]), .O(main_dout_leaf_2[i]));
		SYN_IBUF out_ibuf_dout_leaf_6(.I(dout_leaf_6[i]), .O(main_dout_leaf_6[i]));
		SYN_IBUF out_ibuf_dout_leaf_9(.I(dout_leaf_9[i]), .O(main_dout_leaf_9[i]));
		SYN_IBUF out_ibuf_dout_leaf_10(.I(dout_leaf_10[i]), .O(main_dout_leaf_10[i]));
		SYN_IBUF out_ibuf_dout_leaf_11(.I(dout_leaf_11[i]), .O(main_dout_leaf_11[i]));
		SYN_IBUF out_ibuf_dout_leaf_13(.I(dout_leaf_13[i]), .O(main_dout_leaf_13[i]));
	end
endgenerate
...
generate
	for (i=0; i < 49; i=i+1) begin
		SYN_OBUF in_obuf_din_leaf_2(.I(main_din_leaf_2[i]), .O(din_leaf_2[i]));
		SYN_OBUF in_obuf_din_leaf_6(.I(main_din_leaf_6[i]), .O(din_leaf_6[i]));
		SYN_OBUF in_obuf_din_leaf_9(.I(main_din_leaf_9[i]), .O(din_leaf_9[i]));
		SYN_OBUF in_obuf_din_leaf_10(.I(main_din_leaf_10[i]), .O(din_leaf_10[i]));
		SYN_OBUF in_obuf_din_leaf_11(.I(main_din_leaf_11[i]), .O(din_leaf_11[i]));
		SYN_OBUF in_obuf_din_leaf_13(.I(main_din_leaf_13[i]), .O(din_leaf_13[i]));
	end
endgenerate
...
SYN_OBUF in_obuf_resend_2(.I(main_resend_2), .O(resend_2));
SYN_OBUF in_obuf_resend_6(.I(main_resend_6), .O(resend_6));
SYN_OBUF in_obuf_resend_9(.I(main_resend_9), .O(resend_9));
SYN_OBUF in_obuf_resend_10(.I(main_resend_10), .O(resend_10));
SYN_OBUF in_obuf_resend_11(.I(main_resend_11), .O(resend_11));
SYN_OBUF in_obuf_resend_13(.I(main_resend_13), .O(resend_13));
SYN_OBUF out_obuf_start_signal_2(.I(main_start_signal), .O(start_signal_2));
SYN_OBUF out_obuf_start_signal_6(.I(main_start_signal), .O(start_signal_6));
SYN_OBUF out_obuf_start_signal_9(.I(main_start_signal), .O(start_signal_9));
SYN_OBUF out_obuf_start_signal_10(.I(main_start_signal), .O(start_signal_10));
SYN_OBUF out_obuf_start_signal_11(.I(main_start_signal), .O(start_signal_11));
SYN_OBUF out_obuf_start_signal_13(.I(main_start_signal), .O(start_signal_13));
SYN_OBUF out_ibuf_rst_bft_2(.I(bft_rst), .O(rst_bft_2));
SYN_OBUF out_ibuf_rst_bft_6(.I(bft_rst), .O(rst_bft_6));
SYN_OBUF out_ibuf_rst_bft_9(.I(bft_rst), .O(rst_bft_9));
SYN_OBUF out_ibuf_rst_bft_10(.I(bft_rst), .O(rst_bft_10));
SYN_OBUF out_ibuf_rst_bft_11(.I(bft_rst), .O(rst_bft_11));
SYN_OBUF out_ibuf_rst_bft_13(.I(bft_rst), .O(rst_bft_13));
SYN_OBUF out_obuf_clk_2(.I(bft_clk), .O(clk_bft_2));
SYN_OBUF out_obuf_clk_6(.I(bft_clk), .O(clk_bft_6));
SYN_OBUF out_obuf_clk_9(.I(bft_clk), .O(clk_bft_9));
SYN_OBUF out_obuf_clk_10(.I(bft_clk), .O(clk_bft_10));
SYN_OBUF out_obuf_clk_11(.I(bft_clk), .O(clk_bft_11));
SYN_OBUF out_obuf_clk_13(.I(bft_clk), .O(clk_bft_13));
