...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_gmem_read fifo_out_0_V fifo_out_1_V fifo_out_2_V fifo_out_3_V fifo_out_4_V fifo_out_5_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
