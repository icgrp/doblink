...
set C_modelArgList {
	...
	{ fifo_out_0_V int 32 regular {axi_s 1 volatile  { fifo_out_0_V Data } }  }
	{ fifo_out_1_V int 32 regular {axi_s 1 volatile  { fifo_out_1_V Data } }  }
	{ fifo_out_2_V int 32 regular {axi_s 1 volatile  { fifo_out_2_V Data } }  }
	{ fifo_out_3_V int 32 regular {axi_s 1 volatile  { fifo_out_3_V Data } }  }
	{ fifo_out_4_V int 32 regular {axi_s 1 volatile  { fifo_out_4_V Data } }  }
	{ fifo_out_5_V int 32 regular {axi_s 1 volatile  { fifo_out_5_V Data } }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem_read", "interface" : "axi_master", "bitwidth" : 128, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":127,"cElement": [{"cName": "input.V","cData": "uint128","bit_use": { "low": 0,"up": 127},"offset": { "type": "dynamic","port_name": "input_V","bundle": "control"},"direction": "READWRITE","cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "useable_words", "interface" : "axi_slave", "bundle":"control","type":"ap_memory","bitwidth" : 8, "direction" : "READONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "useable_words","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 5,"step" : 1}]}]}], "offset" : {"in":48}, "offset_end" : {"in":55}} , 
 	{ "Name" : "fifo_out_0_V", "interface" : "axis", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "fifo.V","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 2}]}]}]} , 
 	{ "Name" : "fifo_out_1_V", "interface" : "axis", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "fifo.V","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 1,"up" : 1,"step" : 2}]}]}]} , 
 	{ "Name" : "fifo_out_2_V", "interface" : "axis", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "fifo.V","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 2,"up" : 2,"step" : 2}]}]}]} , 
 	{ "Name" : "fifo_out_3_V", "interface" : "axis", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "fifo.V","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 3,"up" : 3,"step" : 2}]}]}]} , 
 	{ "Name" : "fifo_out_4_V", "interface" : "axis", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "fifo.V","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 4,"up" : 4,"step" : 2}]}]}]} , 
 	{ "Name" : "fifo_out_5_V", "interface" : "axis", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "fifo.V","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 5,"up" : 5,"step" : 2}]}]}]} ]}
...
set portList { 
	...
	{ fifo_out_0_V_TDATA sc_out sc_lv 32 signal 5 } 
	{ fifo_out_0_V_TVALID sc_out sc_logic 1 outvld 5 } 
	{ fifo_out_0_V_TREADY sc_in sc_logic 1 outacc 5 } 
	{ fifo_out_1_V_TDATA sc_out sc_lv 32 signal 6 } 
	{ fifo_out_1_V_TVALID sc_out sc_logic 1 outvld 6 } 
	{ fifo_out_1_V_TREADY sc_in sc_logic 1 outacc 6 } 
	{ fifo_out_2_V_TDATA sc_out sc_lv 32 signal 7 } 
	{ fifo_out_2_V_TVALID sc_out sc_logic 1 outvld 7 } 
	{ fifo_out_2_V_TREADY sc_in sc_logic 1 outacc 7 } 
	{ fifo_out_3_V_TDATA sc_out sc_lv 32 signal 8 } 
	{ fifo_out_3_V_TVALID sc_out sc_logic 1 outvld 8 } 
	{ fifo_out_3_V_TREADY sc_in sc_logic 1 outacc 8 } 
	{ fifo_out_4_V_TDATA sc_out sc_lv 32 signal 9 } 
	{ fifo_out_4_V_TVALID sc_out sc_logic 1 outvld 9 } 
	{ fifo_out_4_V_TREADY sc_in sc_logic 1 outacc 9 } 
	{ fifo_out_5_V_TDATA sc_out sc_lv 32 signal 10 } 
	{ fifo_out_5_V_TVALID sc_out sc_logic 1 outvld 10 } 
	{ fifo_out_5_V_TREADY sc_in sc_logic 1 outacc 10 } 
...
set NewPortList {[ 
	...
	{ "name": "interrupt", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "control", "role": "interrupt" } }, 
 	...
 	{ "name": "fifo_out_0_V_TDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "fifo_out_0_V", "role": "TDATA" }} , 
 	...
 	{ "name": "fifo_out_1_V_TDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "fifo_out_1_V", "role": "TDATA" }} , 
 	...
 	{ "name": "fifo_out_2_V_TDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "fifo_out_2_V", "role": "TDATA" }} , 
 	...
 	{ "name": "fifo_out_3_V_TDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "fifo_out_3_V", "role": "TDATA" }} , 
 	...
 	{ "name": "fifo_out_4_V_TDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "fifo_out_4_V", "role": "TDATA" }} , 
 	{ "name": "fifo_out_4_V_TVALID", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "fifo_out_4_V", "role": "TVALID" }} , 
 	{ "name": "fifo_out_4_V_TREADY", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "outacc", "bundle":{"name": "fifo_out_4_V", "role": "TREADY" }} , 
 	{ "name": "fifo_out_5_V_TDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "fifo_out_5_V", "role": "TDATA" }} , 
 	{ "name": "fifo_out_5_V_TVALID", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "fifo_out_5_V", "role": "TVALID" }} , 
 	{ "name": "fifo_out_5_V_TREADY", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "outacc", "bundle":{"name": "fifo_out_5_V", "role": "TREADY" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "9", "EstimateLatencyMax" : "50330307",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			...
			{"Name" : "fifo_out_4_V", "Type" : "Axis", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "fifo_out_4_V_TDATA_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "fifo_out_5_V", "Type" : "Axis", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "fifo_out_5_V_TDATA_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "first", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "local_words", "Type" : "Memory", "Direction" : "IO"},
			{"Name" : "tail", "Type" : "Memory", "Direction" : "IO"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.local_words_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.tail_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.circ_buff_read_many128_control_s_axi_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.circ_buff_read_many128_gmem_read_m_axi_U", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.data_V_U", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.circ_buff_read_many128_mux_42_8_1_1_U1", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.circ_buff_read_many128_mul_mul_8ns_16ns_24_1_1_U2", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	circ_buff_read_many128 {
		...
		fifo_out_4_V {Type O LastRead -1 FirstWrite 15}
		fifo_out_5_V {Type O LastRead -1 FirstWrite 15}
		first {Type IO LastRead -1 FirstWrite -1}
		local_words {Type IO LastRead -1 FirstWrite -1}
		tail {Type IO LastRead -1 FirstWrite -1}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "9", "Max" : "50330307"}
	, {"Name" : "Interval", "Min" : "10", "Max" : "50330308"}
]}
...
set Spec2ImplPortList { 
	...
	fifo_out_0_V { axis {  { fifo_out_0_V_TDATA out_data 1 32 }  { fifo_out_0_V_TVALID out_vld 1 1 }  { fifo_out_0_V_TREADY out_acc 0 1 } } }
	fifo_out_1_V { axis {  { fifo_out_1_V_TDATA out_data 1 32 }  { fifo_out_1_V_TVALID out_vld 1 1 }  { fifo_out_1_V_TREADY out_acc 0 1 } } }
	fifo_out_2_V { axis {  { fifo_out_2_V_TDATA out_data 1 32 }  { fifo_out_2_V_TVALID out_vld 1 1 }  { fifo_out_2_V_TREADY out_acc 0 1 } } }
	fifo_out_3_V { axis {  { fifo_out_3_V_TDATA out_data 1 32 }  { fifo_out_3_V_TVALID out_vld 1 1 }  { fifo_out_3_V_TREADY out_acc 0 1 } } }
	fifo_out_4_V { axis {  { fifo_out_4_V_TDATA out_data 1 32 }  { fifo_out_4_V_TVALID out_vld 1 1 }  { fifo_out_4_V_TREADY out_acc 0 1 } } }
	fifo_out_5_V { axis {  { fifo_out_5_V_TDATA out_data 1 32 }  { fifo_out_5_V_TVALID out_vld 1 1 }  { fifo_out_5_V_TREADY out_acc 0 1 } } }
}
