...
int main(int argc, char ** argv) 
{
  ...
  // sdsoc version host code
   ...
   // }
    ...
    static hls::stream< ap_uint<32> > frames("test1");
    ...
    for (int i = 0; i < MAX_HEIGHT; i++) 
    {
      ...
      {
    	  tmpframes(31,0) = flo_out.read();
    	  tmpframes(63,32) = flo_out.read();
    	  tmpframes(95,64) = flo_out.read();
    	  tmpframes(127,96) = flo_out.read();
