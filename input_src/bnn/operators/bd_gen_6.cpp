...
#pragma HLS PIPELINE II=1
    Output_1.write(bd_6_0[i](31,  0));
    Output_1.write(bd_6_0[i](63, 32));
  }
 loop_1: for(int i=0; i<4096; i++){
#pragma HLS PIPELINE II=1
    Output_1.write(bd_6_1[i](31,  0));
    Output_1.write(bd_6_1[i](63, 32));
  }
 loop_2: for(int i=0; i<1024; i++){
#pragma HLS PIPELINE II=1
    Output_1.write(bd_6_2[i](31,  0));
    Output_1.write(bd_6_2[i](63, 32));
  }
}
