...
#pragma HLS PIPELINE II=1
    dmem[1][0][in_data_cnt](31,  0) = Input_1.read();
    dmem[1][0][in_data_cnt](63, 32) = Input_1.read();
  }
...
#pragma HLS PIPELINE
  ...
  for(unsigned int dmem_j=0; dmem_j<CONVOLVERS; dmem_j++)
    for(unsigned int dmem_k=0; dmem_k<C_DMEM_WORDS; dmem_k++){
      Output_1.write(dmem[0][dmem_j][dmem_k](31,  0));
      Output_1.write(dmem[0][dmem_j][dmem_k](63, 32));
    }
