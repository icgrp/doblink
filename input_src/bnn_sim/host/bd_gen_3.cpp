...
bit32 out_tmp;
 ...
 loop_0: for(int i=0; i<16384; i++){
	#pragma HLS PIPELINE II=2
	out_tmp = bd_3_0[i](63, 32);
	Output_1.write(out_tmp);
	out_tmp = bd_3_0[i](31,  0);
	Output_1.write(out_tmp);
  }
 loop_1: for(int i=0; i<4096; i++){
	#pragma HLS PIPELINE II=2
	out_tmp = bd_3_1[i](63, 32);
	Output_1.write(out_tmp);
	out_tmp = bd_3_1[i](31,  0);
	Output_1.write(out_tmp);
  }
 loop_2: for(int i=0; i<1024; i++){
	#pragma HLS PIPELINE II=2
	out_tmp = bd_3_2[i](63, 32);
	Output_1.write(out_tmp);
	out_tmp = bd_3_2[i](31,  0);
	Output_1.write(out_tmp);
  }
 loop_3: for(int i=0; i<512; i++){
	#pragma HLS PIPELINE II=2
	out_tmp = bd_3_3[i](63, 32);
	Output_1.write(out_tmp);
	out_tmp = bd_3_3[i](31,  0);
	Output_1.write(out_tmp);
  }
}
