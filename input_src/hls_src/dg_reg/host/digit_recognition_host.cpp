...
int main(int argc, char ** argv)
{
  ...
  // sdsoc version host code
    ...
    //Input_1.write(0);
    for (int i = 0; i < NUM_TRAINING / 2; i ++){
    	Input_1.write(training_in0[i].range(255, 224));
    	Input_1.write(training_in0[i].range(223, 192));
    	Input_1.write(training_in0[i].range(191, 160));
    	Input_1.write(training_in0[i].range(159, 128));
    	Input_1.write(training_in0[i].range(127,  96));
    	Input_1.write(training_in0[i].range(95,   64));
    	Input_1.write(training_in0[i].range(63,   32));
    	Input_1.write(training_in0[i].range(31,   0));
    }
    /*for (int i = 0; i < NUM_TRAINING / 2; i ++){
...
//    Input_1.write(1);
    for (int i = 0; i < NUM_TRAINING / 2; i ++){
    	Input_1.write(training_in1[i].range(255, 224));
    	Input_1.write(training_in1[i].range(223, 192));
    	Input_1.write(training_in1[i].range(191, 160));
    	Input_1.write(training_in1[i].range(159, 128));
    	Input_1.write(training_in1[i].range(127,  96));
    	Input_1.write(training_in1[i].range(95,   64));
    	Input_1.write(training_in1[i].range(63,   32));
    	Input_1.write(training_in1[i].range(31,   0));
	}
    /*for (int i = 0; i < NUM_TRAINING / 2; i ++){
