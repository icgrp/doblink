...
int dma_inst::WR2TxBuffer()
{
	...
	for(i = 0; i < num_3d_triangles; i ++) {
		TxPacket[i*12+0] = triangle_3ds[i][0];
		TxPacket[i*12+1] = triangle_3ds[i][1];
		TxPacket[i*12+2] = triangle_3ds[i][2];
		TxPacket[i*12+3] = triangle_3ds[i][3];
		TxPacket[i*12+4] = triangle_3ds[i][4];
		TxPacket[i*12+5] = triangle_3ds[i][5];
		TxPacket[i*12+6] = triangle_3ds[i][6];
		TxPacket[i*12+7] = triangle_3ds[i][7];
		TxPacket[i*12+8] = triangle_3ds[i][8];
	}
