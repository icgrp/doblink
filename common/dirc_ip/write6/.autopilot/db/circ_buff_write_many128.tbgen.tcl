...
set C_modelArgList {
	...
	{ fifo_in_0_V int 32 regular {axi_s 0 volatile  { fifo_in_0_V Data } }  }
	{ fifo_in_1_V int 32 regular {axi_s 0 volatile  { fifo_in_1_V Data } }  }
	{ fifo_in_2_V int 32 regular {axi_s 0 volatile  { fifo_in_2_V Data } }  }
	{ fifo_in_3_V int 32 regular {axi_s 0 volatile  { fifo_in_3_V Data } }  }
	{ fifo_in_4_V int 32 regular {axi_s 0 volatile  { fifo_in_4_V Data } }  }
	{ fifo_in_5_V int 32 regular {axi_s 0 volatile  { fifo_in_5_V Data } }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem_out", "interface" : "axi_master", "bitwidth" : 128, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":127,"cElement": [{"cName": "output.V","cData": "uint128","bit_use": { "low": 0,"up": 127},"offset": { "type": "dynamic","port_name": "output_V","bundle": "control"},"direction": "READWRITE","cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "fifo_in_0_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "fifo.V","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 2}]}]}]} , 
 	{ "Name" : "fifo_in_1_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "fifo.V","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 1,"up" : 1,"step" : 2}]}]}]} , 
 	{ "Name" : "fifo_in_2_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "fifo.V","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 2,"up" : 2,"step" : 2}]}]}]} , 
 	{ "Name" : "fifo_in_3_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "fifo.V","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 3,"up" : 3,"step" : 2}]}]}]} , 
 	{ "Name" : "fifo_in_4_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "fifo.V","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 4,"up" : 4,"step" : 2}]}]}]} , 
 	{ "Name" : "fifo_in_5_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "fifo.V","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 5,"up" : 5,"step" : 2}]}]}]} ]}
...
set portList { 
	...
	{ fifo_in_0_V_TDATA sc_in sc_lv 32 signal 5 } 
	{ fifo_in_0_V_TVALID sc_in sc_logic 1 invld 5 } 
	{ fifo_in_0_V_TREADY sc_out sc_logic 1 inacc 5 } 
	{ fifo_in_1_V_TDATA sc_in sc_lv 32 signal 6 } 
	{ fifo_in_1_V_TVALID sc_in sc_logic 1 invld 6 } 
	{ fifo_in_1_V_TREADY sc_out sc_logic 1 inacc 6 } 
	{ fifo_in_2_V_TDATA sc_in sc_lv 32 signal 7 } 
	{ fifo_in_2_V_TVALID sc_in sc_logic 1 invld 7 } 
	{ fifo_in_2_V_TREADY sc_out sc_logic 1 inacc 7 } 
	{ fifo_in_3_V_TDATA sc_in sc_lv 32 signal 8 } 
	{ fifo_in_3_V_TVALID sc_in sc_logic 1 invld 8 } 
	{ fifo_in_3_V_TREADY sc_out sc_logic 1 inacc 8 } 
	{ fifo_in_4_V_TDATA sc_in sc_lv 32 signal 9 } 
	{ fifo_in_4_V_TVALID sc_in sc_logic 1 invld 9 } 
	{ fifo_in_4_V_TREADY sc_out sc_logic 1 inacc 9 } 
	{ fifo_in_5_V_TDATA sc_in sc_lv 32 signal 10 } 
	{ fifo_in_5_V_TVALID sc_in sc_logic 1 invld 10 } 
	{ fifo_in_5_V_TREADY sc_out sc_logic 1 inacc 10 } 
...
set NewPortList {[ 
	...
	{ "name": "interrupt", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "control", "role": "interrupt" } }, 
 	...
 	{ "name": "fifo_in_0_V_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "fifo_in_0_V", "role": "TDATA" }} , 
 	...
 	{ "name": "fifo_in_1_V_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "fifo_in_1_V", "role": "TDATA" }} , 
 	...
 	{ "name": "fifo_in_2_V_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "fifo_in_2_V", "role": "TDATA" }} , 
 	...
 	{ "name": "fifo_in_3_V_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "fifo_in_3_V", "role": "TDATA" }} , 
 	...
 	{ "name": "fifo_in_4_V_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "fifo_in_4_V", "role": "TDATA" }} , 
 	{ "name": "fifo_in_4_V_TVALID", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "fifo_in_4_V", "role": "TVALID" }} , 
 	{ "name": "fifo_in_4_V_TREADY", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "inacc", "bundle":{"name": "fifo_in_4_V", "role": "TREADY" }} , 
 	{ "name": "fifo_in_5_V_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "fifo_in_5_V", "role": "TDATA" }} , 
 	{ "name": "fifo_in_5_V_TVALID", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "fifo_in_5_V", "role": "TVALID" }} , 
 	{ "name": "fifo_in_5_V_TREADY", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "inacc", "bundle":{"name": "fifo_in_5_V", "role": "TREADY" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6"],
		...
		"Port" : [
			...
			{"Name" : "fifo_in_4_V", "Type" : "Axis", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "fifo_in_4_V_TDATA_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "fifo_in_5_V", "Type" : "Axis", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "fifo_in_5_V_TDATA_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "first", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "local_words", "Type" : "Memory", "Direction" : "IO"},
			{"Name" : "head", "Type" : "Memory", "Direction" : "IO"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.local_words_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.head_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.circ_buff_write_many128_control_s_axi_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.circ_buff_write_many128_gmem_out_m_axi_U", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.data_V_U", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.circ_buff_write_many128_mux_42_8_1_1_U1", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	circ_buff_write_many128 {
		...
		fifo_in_4_V {Type I LastRead 13 FirstWrite -1}
		fifo_in_5_V {Type I LastRead 13 FirstWrite -1}
		first {Type IO LastRead -1 FirstWrite -1}
		local_words {Type IO LastRead -1 FirstWrite -1}
		head {Type IO LastRead -1 FirstWrite -1}}}
...
set Spec2ImplPortList { 
	...
	fifo_in_0_V { axis {  { fifo_in_0_V_TDATA in_data 0 32 }  { fifo_in_0_V_TVALID in_vld 0 1 }  { fifo_in_0_V_TREADY in_acc 1 1 } } }
	fifo_in_1_V { axis {  { fifo_in_1_V_TDATA in_data 0 32 }  { fifo_in_1_V_TVALID in_vld 0 1 }  { fifo_in_1_V_TREADY in_acc 1 1 } } }
	fifo_in_2_V { axis {  { fifo_in_2_V_TDATA in_data 0 32 }  { fifo_in_2_V_TVALID in_vld 0 1 }  { fifo_in_2_V_TREADY in_acc 1 1 } } }
	fifo_in_3_V { axis {  { fifo_in_3_V_TDATA in_data 0 32 }  { fifo_in_3_V_TVALID in_vld 0 1 }  { fifo_in_3_V_TREADY in_acc 1 1 } } }
	fifo_in_4_V { axis {  { fifo_in_4_V_TDATA in_data 0 32 }  { fifo_in_4_V_TVALID in_vld 0 1 }  { fifo_in_4_V_TREADY in_acc 1 1 } } }
	fifo_in_5_V { axis {  { fifo_in_5_V_TDATA in_data 0 32 }  { fifo_in_5_V_TVALID in_vld 0 1 }  { fifo_in_5_V_TREADY in_acc 1 1 } } }
}
