...
//data_redir_m.Output_1->rasterization2_m.Input_1
  write_to_fifo(0x7000, 0x96201fc0, &ctrl_reg);
  write_to_fifo(0x6100, 0x27900000, &ctrl_reg);
...
//DMA.Output_1->data_redir_m.Input_1
  write_to_fifo(0x1000, 0x97201fc0, &ctrl_reg);
  write_to_fifo(0x7100, 0x21900000, &ctrl_reg);
//zculling_top.Output_1->coloringFB_bot_m.Input_1
  write_to_fifo(0x2000, 0x95201fc0, &ctrl_reg);
  write_to_fifo(0x5100, 0x22900000, &ctrl_reg);
//rasterization2_m.Output_1->zculling_top.Input_1
  write_to_fifo(0x6000, 0x92201fc0, &ctrl_reg);
  write_to_fifo(0x2100, 0x26900000, &ctrl_reg);
	//packet anchor
