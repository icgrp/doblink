...
//Sigmoid_axi.Output_1->dotProduct_1.Input_2
  write_to_fifo(0x7000, 0x92301fc0, &ctrl_reg);
  write_to_fifo(0x2100, 0x37900000, &ctrl_reg);
...
//data_1_4_2.Output_2->dotProduct_2.Input_1
  write_to_fifo(0x4000, 0xa6201fc0, &ctrl_reg);
  write_to_fifo(0x6100, 0x24a00000, &ctrl_reg);
//dotProduct_1.Output_2->data_1_4_1.Input_2
  write_to_fifo(0x2000, 0xa3301fc0, &ctrl_reg);
  write_to_fifo(0x3100, 0x32a00000, &ctrl_reg);
...
//DMA.Output_1->data_in_redir.Input_1
  write_to_fifo(0x1000, 0x95201fc0, &ctrl_reg);
  write_to_fifo(0x5100, 0x21900000, &ctrl_reg);
//data_1_4_1.Output_1->dotProduct_1.Input_1
  write_to_fifo(0x3000, 0x92201fc0, &ctrl_reg);
  write_to_fifo(0x2100, 0x23900000, &ctrl_reg);
...
//dotProduct_1.Output_1->Sigmoid_axi.Input_1
  write_to_fifo(0x2000, 0x97201fc0, &ctrl_reg);
  write_to_fifo(0x7100, 0x22900000, &ctrl_reg);
//data_in_redir.Output_2->data_1_4_2.Input_1
  write_to_fifo(0x5000, 0xa4201fc0, &ctrl_reg);
  write_to_fifo(0x4100, 0x25a00000, &ctrl_reg);
	//packet anchor
