...
(* CORE_GENERATION_INFO="update_knn1_update_knn1,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7a200t-sbg484-1,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=3.678000,HLS_SYN_LAT=110779,HLS_SYN_TPT=56760,HLS_SYN_MEM=32,HLS_SYN_DSP=0,HLS_SYN_FF=24623,HLS_SYN_LUT=13695,HLS_VERSION=2020_2}" *)
...
update_knn1_fifo_w32_d8_S knn_out1_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
