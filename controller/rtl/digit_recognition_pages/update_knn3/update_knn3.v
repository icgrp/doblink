...
(* CORE_GENERATION_INFO="update_knn3_update_knn3,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7a200t-sbg484-1,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.920000,HLS_SYN_LAT=30226,HLS_SYN_TPT=none,HLS_SYN_MEM=15,HLS_SYN_DSP=0,HLS_SYN_FF=3319,HLS_SYN_LUT=4859,HLS_VERSION=2020_2}" *)
...
update_knn3_popcount grp_popcount_fu_497(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
assign icmp_ln157_fu_602_p2 = ((ap_phi_mux_i_1_phi_fu_206_p4 == 13'd6300) ? 1'b1 : 1'b0);
...
assign select_ln95_2_fu_1128_p3 = ((icmp_ln95_fu_1123_p2[0:0] == 1'b1) ? 32'd2 : p_0104_reg_453);

assign select_ln95_3_fu_1136_p3 = ((icmp_ln95_fu_1123_p2[0:0] == 1'b1) ? zext_ln80_reg_1464 : p_0101_reg_475);

assign select_ln95_4_fu_1159_p3 = ((icmp_ln90_1_fu_1118_p2[0:0] == 1'b1) ? 32'd2 : p_0_reg_442);

assign select_ln95_5_fu_1167_p3 = ((icmp_ln90_1_fu_1118_p2[0:0] == 1'b1) ? zext_ln80_reg_1464 : p_0102_reg_486);

assign select_ln95_fu_1089_p3 = ((and_ln81_1_reg_1503[0:0] == 1'b1) ? 32'd2 : p_0103_reg_431);
