...
class AxilCDC(Module):
    def __init__(self, s_clk, s_rst, m_clk, m_rst, platform, s_clock_domain='sys', m_clock_domain='sys'):
        self.slave = PldAXILiteInterface(data_width=32, address_width=5, clock_domain=s_clock_domain)
        self.master = PldAXILiteInterface(data_width=32, address_width=5, clock_domain=m_clock_domain)
        self.s_clk = s_clk
        self.s_rst = s_rst
        self.m_clk = m_clk
        self.m_rst = m_rst
