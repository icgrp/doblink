...
_io = [
    ...
    (
        "usb_fifo",
        0,  # Can be used when FT2232H's Channel A configured to ASYNC FIFO 245 mode
    ...
    (
        ...
        Subsignal(
            "a",
            Pins("M2 M5 M3 M1 L6 P1 N3 N2", "M6 R1 L5 N5 N4 P2 P6"),
            IOStandard("SSTL15"),
        ),
        ...
        Subsignal(
            "dq",
            Pins("G2 H4 H5 J1 K1 H3 H2 J5", "E3 B2 F3 D2 C2 A1 E2 B1"),
            IOStandard("SSTL15"),
...
class Platform(XilinxPlatform):
    ...
    def __init__(self, toolchain="vivado"):
        XilinxPlatform.__init__(
            self, "xc7a200t-sbg484-1", _io, _connectors, toolchain=toolchain
        )
    ...
    def do_finalize(self, fragment):
        ...
        self.add_period_constraint(
            self.lookup_request("eth_clocks:rx", loose=True), 1e9 / 125e6
        )
